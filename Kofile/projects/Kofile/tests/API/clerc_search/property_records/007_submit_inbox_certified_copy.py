...
class test(ApiTestParent):
    ...
    def __before__(self):
        ...
        self.run_dependencies(("cs_first_rp_order", "certified_copy_first_rp_order"))
        self.set("cs_first_rp_order", self.get("certified_copy_first_rp_order"))
    ...
    def post_data(self):
        ...
        data["InboxCartItems"][0]["OrderType"] = {"Id": "4", "Desc": "Certified Copy"}
        data["InboxCartItems"][0]["Comment"] = "Certified copy api test"
        return data
    ...
    def __test__(self):
        ...
        self.set("cs_certified_copy_order_number", num)
        self.logging.info(f"CERTIFIED COPY ORDER {num}")
        self.set("cs_order_in_inbox", None)
