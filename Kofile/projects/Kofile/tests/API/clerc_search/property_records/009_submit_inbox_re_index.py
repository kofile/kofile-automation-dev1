...
class test(ApiTestParent):
    ...
    def __before__(self):
        ...
        self.run_dependencies(("cs_first_rp_order", "re_index_first_rp_order"))
        self.set("cs_first_rp_order", self.get("re_index_first_rp_order"))
    ...
    def post_data(self):
        ...
        data["InboxCartItems"][0]["OrderType"] = {"Id": "12", "Desc": "Re-Index"}
        data["InboxCartItems"][0]["Comment"] = "Re index api test"
        return data
    ...
    def __test__(self):
        ...
        self.set("cs_re_index_order_number", num)
        self.logging.info(f"RE INDEX ORDER {num}")
        self.set("cs_order_in_inbox", None)
