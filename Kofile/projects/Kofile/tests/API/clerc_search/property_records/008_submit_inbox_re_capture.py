...
class test(ApiTestParent):
    ...
    def __before__(self):
        ...
        self.run_dependencies(("cs_first_rp_order", "re_capture_first_rp_order"))
        self.set("cs_first_rp_order", self.get("re_capture_first_rp_order"))
    ...
    def post_data(self):
        ...
        data["InboxCartItems"][0]["OrderType"] = {"Id": "13", "Desc": "Re-Capture"}
        data["InboxCartItems"][0]["Comment"] = "Re capture api test"
        return data
    ...
    def __test__(self):
        ...
        self.set("cs_re_capture_order_number", num)
        self.logging.info(f"RE CAPTURE ORDER {num}")
        self.set("cs_order_in_inbox", None)
