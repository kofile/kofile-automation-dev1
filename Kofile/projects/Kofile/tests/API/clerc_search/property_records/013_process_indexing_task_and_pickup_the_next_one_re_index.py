...
class test(ApiTestParent):                                                                                   # noqa
    ...
    @property
    def post_data(self):
        return {'indexingTaskId': self.get("cs_re_index_indexing_task_id")}

    def __before__(self):
        self.run_dependencies(("re_index_order_item_saved_in_indexing", "cs_re_index_indexing_task_id"))
    ...
    def __test__(self):
        ...
        self.call_module(self.data_mapping.get("search_by_order_number"),
                         order_number=self.get("cs_re_index_order_number"), status="Archive")
