...
class test(ApiTestParent):
    ...
    @property
    def post_data(self):
        self.random_int = self.random.randint(1, 3000)
        return {
            ...
            'Address.AddressLine1': f'test str {self.random_int}',
            'Address.ZipCode': '',
            'Address.City': '',
            'Address.StateCode': '',
            'MinimumBalance': '0',
                ...
                "Address": {
                    ...
                    "properties": {
                        ...
                        "AddressLine1": {
                            ...
                            "title": "Addressline1",
                            "type": "string",
                            "pattern": f"^test str {self.random_int}$"
                        },
                        "AddressLine2": {
                        ...
                        "FullAddress": {
                            ...
                            "type": "string",
                            "default": "",
                            "pattern": f"^{self.get('company_account_name')} test str {self.random_int}$"
                        },
                        "FullAddressWithoutZip": {
    ...
    def __test__(self):
        ...
        self.set("company_account_user_removed", True)
