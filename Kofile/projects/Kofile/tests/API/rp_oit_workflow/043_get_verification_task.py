...
class test(ApiTestParent):                                                                             # noqa
    ...
    @property
    def post_data(self):
        return ('verificationTaskId', self.get("verification_task_id")), ('verificationTaskStatus', '1'),
    ...
    def __test__(self):
        ...
        self.response = self.session.get(self.get_url(self.api_urls.GetVerificationTask), params=self.post_data)
