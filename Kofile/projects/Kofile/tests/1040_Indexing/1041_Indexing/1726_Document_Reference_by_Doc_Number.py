...
description = """
    ...
    Enter a Document # of existing document  in Document Reference field ->
    The existing document is found and its Type, Volume and Page are correctly displayed next to the field
        """
