...
description = """
   ...
   Export search results to PDF -> Search results are downloaded in PDF format
   Open the downloaded PDF doc and check the column data -> All columns are correctly filled with corresponding data
