...
description = """
    Go to CS, submit 'Re-Capture' to CRS by DOC number, finalize and check order
        """
...
class test(TestParent):                                                                               # noqa
    ...
    def __test__(self):
        ...
        self.atom.CRS.order_search.verify_order_status("Capture")
        # Go to 'Capture Queue' and process Re-Capture order
        self.atom.CRS.capture.process_recapture_order()
        # Go to 'Order Search' and verify document status
