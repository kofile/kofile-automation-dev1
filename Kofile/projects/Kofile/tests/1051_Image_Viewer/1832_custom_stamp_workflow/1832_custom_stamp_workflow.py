...
class test(TestParent):                                                                                # noqa
    ...
    def __test__(self):
        ...
        custom_stamp_locator = self.pages.CRS.image_viewer.icn_C2 if self.data["custom_stamp"] == "C2_stamp" \
            else self.pages.CRS.image_viewer.icn_C1
        ...
        if self.data['config'].test_data(f"{self.data.OIT}.indexing.step"):
            ...
            if is_self:
                ...
                self.lib.CRS.image_viewer.add_custom_stamp(custom_stamp_locator, "Indexing")
                self.lib.CRS.image_viewer.verify_text_on_image(self.data, custom_stamp_text, last_page=False,
                                                               step="Indexing")
        ...
        self.lib.CRS.image_viewer.verify_text_on_image(self.data, custom_stamp_text, last_page=False, step="Re-Capture")
