"""69865_Send_Order_to_Admin_from_Verification"""
...
class test(TestParent):  # noqa
    ...
    def __test__(self):
        """
        Pre-conditions: no
        Post-conditions: Order in Verification Queue with status 'AdminSuspend'
        """
        ...
        # Send order to Administrator and verify order status
        self.atom.CRS.verification.send_to_admin()
